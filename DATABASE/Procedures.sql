...
## EVENTO
DELIMITER $$
CREATE PROCEDURE atualiza_evento (cod_e INT, nome VARCHAR(100), organizacao VARCHAR(200), data_evento DATE, rua VARCHAR(100), comunidade VARCHAR(200), car INT, cit INT)
BEGIN
	IF ((nome != '') && (data_evento != '') && (organizacao != '') && (rua != '') && (comunidade != '') && (car != '') && (cit != '')) THEN
        ...
        data_evento=data_evento, rua_evento=rua, nome_comunidade=comunidade,cod_cardapio=car, 
