...
if (isset($login_cookie)) {
    ...
    <div class="container col-sm-6">
        <form class="form-horizontal" method="POST" action="adicionar/adcBD_sobre.php" enctype="multipart/form-data">
            ...
            <hr class="b-s-dashed">
            <div class="form-group">
                <label for="desc" class="col-sm-4 control-label">Descrição do Sobre:</label>
                <div class="col-sm-12">
                    <textarea class="form-control" rows="5" id="desc" name="descricao_sobre" required placeholder="Digite a Descrição..."></textarea>
                </div>
            </div>
            <hr class="b-s-dashed">
            <div class="form-group">
